...
def main():
    # Read Video
    input_video_path = "input_videos/video_input4.mp4"
    output_video_path = "output_videos/video_output4.avi"
    ...
    player_detections = player_tracker.detect_frames(video_frames,
                                                     ...
                                                     stub_path="tracker_stubs/player_detections_video_input4.pkl"
                                                     )
    ball_detections = ball_tracker.detect_frames(video_frames,
                                                     read_from_stub=False,
                                                     stub_path="tracker_stubs/ball_detections_video_input4.pkl"
                                                     )
